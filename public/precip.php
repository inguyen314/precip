...
<html lang="en">
    <head>
        ...
        <title>Precip <?php if ($type=="inc") { echo "Incremental"; } else if ($type=="cum") { echo "Cummulative"; } ?></title>
									...
									<div class="content">
                                        ...
                                        <table id="precip_title">
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td><p><strong><a href="precip.php?basin=Mississippi&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Mississippi</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Ohio&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Ohio</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Salt&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Salt</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Cuivre&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Cuivre</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Illinois&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Illinois</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Missouri&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Missouri</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Meramec&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Meramec</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Kaskaskia&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Kaskaskia</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=Big Muddy&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">Big Muddy</a></strong></p></td>
                                                <td><p><strong><a href="precip.php?basin=St Francis&type=<?php if ($type=="inc") { echo "inc"; } else if ($type=="cum") { echo "cum"; } ?>">St Francis</a></strong></p></td>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            </tr>
